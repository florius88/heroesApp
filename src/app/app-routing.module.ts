...
/* import { AuthDeprecatedGuard } from './auth/guards/auth-deprecated.guard'; */
...
const routes: Routes = [
  ...
  },
  {
    ...
    /* Deprecated
    canActivate: [ AuthDeprecatedGuard ],
    canMatch: [ AuthDeprecatedGuard ], */
  ...
  },
  {
    path: '',
    redirectTo: 'heroes',
    pathMatch: 'full' // que la ruta sea exactamente igual
  },
  {
    path: '**',
    redirectTo: '404',
